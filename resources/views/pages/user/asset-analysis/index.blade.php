...
@section('content')
    <div class="row">
        ...
        <input type="hidden" id="sidebar-state" value="visible">
        ...
        <div id="asset-sidebar" class="col-lg-3 transition-width">
            ...
            <div class="card mb-3" style="position: sticky; top: 90px; z-index: 10;">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Asset Selection</h5>
                    <button id="collapse-sidebar" class="btn btn-primary" title="Hide Asset Panel">
                        <i class="ti ti-chevron-left"></i>
                    </button>
                </div>
                <div class="card-body">
                    <!-- PERBAIKAN: Menempatkan input pencarian di dalam komponen Livewire agar terhubung dengan properti search -->
        ...
        <div id="analysis-content" class="col-lg-9 transition-width">
            <!-- Chart Display -->
            <div class="card mb-3">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            collapseSidebarBtn.addEventListener('click', function() {
                ...
                assetSidebar.classList.remove('col-lg-3');
                assetSidebar.classList.add('col-lg-1');
                collapsedToggle.classList.remove('d-none');

                // Expand content
                analysisContent.classList.remove('col-lg-9');
                analysisContent.classList.add('col-lg-11');
            ...
            expandSidebarBtn.addEventListener('click', function() {
                ...
                assetSidebar.classList.remove('col-lg-1');
                assetSidebar.classList.add('col-lg-3');
                collapsedToggle.classList.add('d-none');

                // Reduce content width
                analysisContent.classList.remove('col-lg-11');
                analysisContent.classList.add('col-lg-9');
                sidebarState.value = 'visible';
